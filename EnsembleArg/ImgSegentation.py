...
img = cv2.imread('C:/Users/Istiak/Desktop/Image/train_1/*') 
...
labeled_img = cv2.imread('C:/Users/Istiak/Desktop/Image/1/ID1012_2_g1.png') 
...
model = RandomForestClassifier(n_estimators = 25, random_state= 32)
model.fit(X_train, Y_train)
prediction_test = model.predict(X_test)

print('Predicts:', prediction_test)
